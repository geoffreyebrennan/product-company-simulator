      ...
      >
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20 }}>
          <div>
            ...
            <h3 style={{ margin: 0, fontSize: 18, fontWeight: 900, color: '#2a1f0e', fontFamily: "'Rubik', serif" }}>
              {title}
            </h3>
          </div>
          <button
  ...
  return (
    ...
    >
      <div>
        ...
        <h3 style={{ margin: '0 0 5px', fontSize: 15, fontWeight: 900, color: '#2a1f0e', fontFamily: "'Rubik', serif", lineHeight: 1.3 }}>
          {event.headline}
        </h3>
...
function BoardMeetingModal({ month, questions, onDone }: {
  ...
  return (
    ...
    />
          ...
          <h2 style={{ margin: '0 0 8px', fontSize: 24, fontWeight: 900, color: '#2a1f0e', fontFamily: "'Rubik', serif" }}>
        ...
        {questions.map((q, qi) => (
          <div key={qi} style={{ marginBottom: 22 }}>
            <div style={{
              ...
              fontFamily: "'Rubik', serif", lineHeight: 1.35, marginBottom: 10,
            }}>
              "{q.question}"
            </div>
        ...
        {!revealed ? (
          <button
            ...
            style={{
              ...
              fontFamily: "'Rubik', serif", letterSpacing: '0.04em',
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              color: '#fff', border: 'none', borderRadius: 12,
              padding: '13px 0', fontSize: 15, fontWeight: 800,
              cursor: 'pointer', fontFamily: "'Rubik', serif",
  ...
  return (
    ...
    />
          <h1 style={{
            ...
            fontWeight: 900, fontFamily: "'Rubik', serif",
          ...
          {scenarios.map(sc => {
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 17, fontWeight: 900, color: active ? '#fff' : '#2a1f0e', fontFamily: "'Rubik', serif", marginBottom: 6 }}>
                  {sc.name}
                </div>
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 660, width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 38, fontWeight: 900, color: '#2a1f0e', margin: '0 0 8px', fontFamily: "'Rubik', serif" }}>
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0e8d2 0%, #e8d8b5 100%)', fontFamily: "'Nunito', sans-serif" }}>
      ...
      style={{
        ...
        objectFit: "cover",
          ...
          <span style={{ fontFamily: "'Rubik', serif", fontWeight: 900, color: '#f0e0a8', fontSize: 17 }}>
            Product Company Simulator
          </span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontFamily: "'Rubik', serif", fontWeight: 800, color: '#f0e0a8', fontSize: 14 }}>
              Month {month} of 60
            </div>
      ...
      <div style={{ padding: '18px 18px 40px', maxWidth: 1080, margin: '0 auto' }}>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: "'Rubik', serif", letterSpacing: '0.05em',
